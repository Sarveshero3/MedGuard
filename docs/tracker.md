...
| Vertical winding flowchart (v2 — segment-based) | `frontend/src/components/MedGuardFlowchart.jsx` | ✅ |
| Flowchart styles (v2 — alternating layout) | `frontend/src/components/MedGuardFlowchart.css` | ✅ |
